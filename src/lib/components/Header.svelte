    ...
    <nav>
        ...
        <div class="menu">
            <a href="/" class="fdnd-logo">
                <span class="sr-only"><abbr title="Frontend Design & Development"><span>FDND</span></abbr></span>
...
.fdnd-logo svg rect,
.fdnd-logo svg path:first-of-type {
    fill: var(--green);
}
